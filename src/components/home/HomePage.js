...
function HomePage () {
	return (
		<CenterPage title="Recent Builds">
			<div style={HomeStyle.recent_build}>
				<img style={HomeStyle.recent_build_img} src={require("../../../images/recentbuild1.jpeg")} alt="Build 1"/>
				<p>
			...
			<div style={HomeStyle.recent_build}>
				<img style={HomeStyle.recent_build_img} src={require("../../../images/recentbuild2.jpeg")} alt="Build 2"/>
				<p>
