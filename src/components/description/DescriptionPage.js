    ...
    render() {
        return (
            <CenterPage title={this.state.title}>
                <div id="description">
                    <textarea id="text" className="description_box" placeholder="Add a description of the type of computer you want to build" rows="3" cols="50" value={this.state.text} onChange={(event) => this.setState( {text: event.target.value} )}></textarea>
